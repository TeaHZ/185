    ...
    internal class GETPATRECORD
    {
        public static string B_GETPATRECORD(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_Common", "0002").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
        ...
        #region
        //public static string B_GETPATRECORD_b(string json_in)
        //{
        //    DataReturn dataReturn = new DataReturn();
        //    string json_out = "";
        //    try
        //    {
        //        GETPATRECORD_M.GETPATRECORD_IN _in = JsonConvert.DeserializeObject<GETPATRECORD_M.GETPATRECORD_IN>(json_in);
