    ...
    internal class WDPRINT
    {
        public static string B_WDPRINT(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_InHos", "0012").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
        ...
        #region
        //public static string B_WDPRINT_b(string json_in)
        //{
        //    DataReturn dataReturn = new DataReturn();
        //    string json_out = "";
        //    try
        //    {
        //        WDPRINT_M.WDPRINT_IN _in = JsonConvert.DeserializeObject<WDPRINT_M.WDPRINT_IN>(json_in);
