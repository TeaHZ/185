...
{
    internal class EInvoiceIssue_B
    {
        public static string B_EInvoiceIssue(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_EInvoice", "0004").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
