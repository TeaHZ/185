    ...
    internal class GETMEDICALRECORD
    {
        public static string B_GETMEDICALRECORD(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_Report", "0010").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
        ...
        public static string B_GETMEDICALRESULT(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_Report", "0011").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
        ...
        public static string B_ZZJMEDICALPRNBACK(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_Report", "0012").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
