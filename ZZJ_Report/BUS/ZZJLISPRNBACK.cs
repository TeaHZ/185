    ...
    internal class ZZJLISPRNBACK
    {
        public static string B_ZZJLISPRNBACK(string json_in)
        {
            ...
            try
            {
                ...
                string out_data = GlobalVar.CallOtherBus(json_in, FormatHelper.GetStr(dic["HOS_ID"]), "ZZJ_Report", "0003").BusData;
                return out_data;
            }
            catch (Exception ex)
            {
        ...
        #region
        //public static string B_ZZJLISPRNBACK_b(string json_in)
        //{
        //    DataReturn dataReturn = new DataReturn();
        //    string json_out = "";
        //    try
