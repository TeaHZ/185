...
namespace OnlineBusHos185
{
    ...
    public class FormatHelper
    {
        ...
        /// <returns></returns>
        public static string GetDTCellValue(DataTable dt, int row, string colName)
        {
            try
            {
                if (dt.Columns.Contains(colName))
                {
                    return dt.Rows[row][colName].ToString().Trim();
                }
                else
                {
                    return "";
        ...
        /// <param name="dc"></param>
        /// <returns></returns>
        public static DateTime GetDate(object dc)
        {
        ...
        /// <param name="dc"></param>
        /// <returns></returns>
        public static DateTime? GetDateTime(object dc)
        {
            try
            {
                return Convert.ToDateTime(dc);
        ...
        /// <returns></returns>
        public static DateTime GetDateTime(object dc, DateTime defaultValue)
        {
            try
            {
                return Convert.ToDateTime(dc);
