...
namespace OnlineBusHos185_GJYB.DAL
{
    //hos_opter
    public partial class hos_opter
    {
        ...
        public void Add(Model.hos_opter model)
        {
            ...
            strSql.Append("HOS_ID,opter_type,opter_no,opter_name,sign_no,sign_date,mac,ip,yb_type");
            ...
            MySqlParameter[] parameters = {
                        ...
                        new MySqlParameter("@yb_type", MySqlDbType.VarChar,50)
            ...
            parameters[8].Value = model.YB_TYPE;
        ...
        public bool Update(Model.hos_opter model)
        {
            ...
            strSql.Append(" ip = @ip  ");
            strSql.Append(" where HOS_ID=@HOS_ID and opter_no=@opter_no and yb_type=@yb_type ");
        ...
        public Model.hos_opter GetModel(string HOS_ID, string opter_no,string ybtype)
        {
            ...
            MySqlParameter[] parameters = {
                    new MySqlParameter("@HOS_ID", MySqlDbType.VarChar,10),
                    new MySqlParameter("@opter_no", MySqlDbType.VarChar,30)  ,
                    new MySqlParameter("@yb_type", MySqlDbType.VarChar,30)       };
            parameters[0].Value = HOS_ID;
            parameters[1].Value = opter_no;
            parameters[2].Value = ybtype;
