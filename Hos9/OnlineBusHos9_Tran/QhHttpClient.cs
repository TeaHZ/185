...
namespace OnlineBusHos9_Tran
{
    public class QhHttpClient
    {
        ...
        public QhHttpClient(string url)
        {
            requestUrl = url;
        }
        ...
        public int SendJson(string strRequestData, Encoding encoder, out string out_data)
        {
            ...
            try
            {
                ...
                QhHttpClient myclient = new QhHttpClient(requestUrl);
        ...
        public static async Task<string> PostAsync(string uri, string paramString, Dictionary<string, string> headers)
        {
